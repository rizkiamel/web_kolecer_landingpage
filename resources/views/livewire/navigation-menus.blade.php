        ...
        <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
            <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead>
                        <tr>
                            <th class="px-6 py-3 bg-gray-50 text-left text-xs leading-4 font-medium text-fray-500 uppercase tracking-wider">Type</th>
                            <th class="px-6 py-3 bg-gray-50 text-left text-xs leading-4 font-medium text-fray-500 uppercase tracking-wider">Sequence</th>
                            <th class="px-6 py-3 bg-gray-50 text-left text-xs leading-4 font-medium text-fray-500 uppercase tracking-wider">Label</th>
                            <th class="px-6 py-3 bg-gray-50 text-left text-xs leading-4 font-medium text-fray-500 uppercase tracking-wider">url</th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @if($data->count())
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-2">
                                    <a class="text-indigo-600 hover:text-indigo-900" target="_blank" href="{{ url($item->slug) }}">{{ $item->slug }}</a>
                                </td>
    ...
    <x-jet-dialog-modal wire:model="modalFormVisible">
            ...
            <x-slot name="content">
                <div class="mt-4">
                    ...
                    <x-jet-input wire:model="label" class="block mt-1 w-full" type="text" />
                ...
                <div class="mt-4">
                    ...
                    <div class="mt-1 flex rounded-md shadow-sm">
                        ...
                        <input wire:model="slug" class="form-input flex-1 block w-full rounded-none rounded-r-md transition duration-150 ease-in-out sm:text-sm sm:loading-5" placeholder="uri-slug">
                    </div>
