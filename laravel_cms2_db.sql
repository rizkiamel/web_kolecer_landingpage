...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 24, 2022 at 10:16 AM
...
CREATE TABLE `hargas` (
  ...
  `renewal_fee` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(9, '2022_03_16_071106_create_sessions_table', 1),
(10, '2022_03_16_072615_create_pages_table', 1),
(11, '2022_03_16_073812_create_trix_rich_texts_table', 1),
(12, '2022_03_18_042122_add_set_default_pages_to_pages_table', 1),
(13, '2022_03_21_065858_create_navigation_menus_table', 1),
(14, '2022_03_22_043754_add_role_to_users_table', 1),
(15, '2022_03_22_064547_create_user_permissions_table', 1),
(16, '2022_03_25_073930_add_google_id_column_in_users_table', 1),
(17, '2022_03_28_064424_create_hargas_table', 1),
(18, '2022_03_28_065028_create_testimonis_table', 1),
(19, '2022_05_10_062129_create_notifications_table', 1),
(20, '2022_07_23_014229_create_table_telepon', 1),
(21, '2022_07_27_013146_create_employees_table', 1),
(22, '2022_07_27_015534_create_transactions_table', 1),
(23, '2022_07_27_093351_create_categories_table', 1),
(24, '2022_07_27_093438_create_products_table', 1),
(25, '2022_07_27_094724_create_category_product_table', 1),
(26, '2022_08_06_092450_create_phones_table', 1),
(27, '2022_08_06_093240_create_address_table', 1);
...
ALTER TABLE `telepon`
  ...
  ADD KEY `telepon_id_users_foreign` (`id_users`);
...
--
ALTER TABLE `telepon`
  ADD CONSTRAINT `telepon_id_users_foreign` FOREIGN KEY (`id_users`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `transactions`
--
ALTER TABLE `transactions`
  ADD CONSTRAINT `transactions_employee_id_foreign` FOREIGN KEY (`employee_id`) REFERENCES `employees` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
